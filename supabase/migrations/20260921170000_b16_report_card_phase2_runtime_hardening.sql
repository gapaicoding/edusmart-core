-- B16 Phase 2 forward-only runtime hardening.
-- Correctly expands canonical composite report-card RPC results in the
-- authenticated transition and publication wrappers.
