...
-- B12 Phase 3 draft-edit remediation.
-- The deployed function's RETURNS TABLE(version bigint) output variable makes
-- unqualified version references ambiguous inside PL/pgSQL. Keep the reviewed
-- command contract intact and qualify only the affected table references.
