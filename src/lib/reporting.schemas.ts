...
export const reportCardDocumentInput = z.object({ reportCardId: uuid }).strict();
export const portalReportCardDocumentInput = z
  .object({ studentId: uuid, reportCardId: uuid })
  .strict();
